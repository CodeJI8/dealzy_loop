      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            const Text('hfouzia27', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
            const Text('Where Quality Meets Affordability.', style: TextStyle(color: Colors.grey)),
